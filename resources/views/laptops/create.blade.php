            ...
            <div class="group-category p-3 mb-4 rounded-3">
                ...
                <div class="row mb-2 ps-5 pe-3">
                    <div class="col-lg-3 col-md-6 g-3 form-floating">
                       <input type="text" name="tag_number" class="form-control" id="tag-number" placeholder="Tag Number" value="{{ old('tag_number', !empty($laptop) ? $laptop->tag_number : '') }}" required data-bs-toggle="popover" data-bs-trigger="focus" data-bs-placement="right" data-bs-html="true" title="Tag Number" data-bs-content="Usually found on a sticker: <br><em>ASOL-####</em>, <em>MSYS-####</em>, etc.">
                ...
                <div class="row mb-2 ps-5 pe-3">
                    <div class="col-lg-3 col-md-6 g-3 form-floating">
                        <input type="text" name="peza_form_number" class="form-control" id="form-number" placeholder="Form Number" value="{{ old('peza_form_number', !empty($laptop) ? $laptop->peza_form_number : '') }}"  data-bs-toggle="popover" data-bs-trigger="focus" data-bs-placement="right" data-bs-html="true" title="PEZA Form Number <em>(optional)</em>" data-bs-content="Usually found on a sticker with PEZA Permit Number">
                ...
                <div class="row mb-2 ps-5 pe-3">
                    <div class="col-lg-3 col-md-6 g-3 form-floating">
                        <input type="text" name="peza_permit_number" class="form-control" id="permit-number" placeholder="Permit Number" value="{{ old('peza_permit_number', !empty($laptop) ? $laptop->peza_permit_number : '') }}" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-placement="right" data-bs-html="true" title="PEZA Permit Number <em>(optional)</em>" data-bs-content="Usually found on a sticker with PEZA Form Number">
                ...
                <div class="row mb-2 ps-5 pe-3">
                    <div class="col-lg-3 col-6 g-3 form-floating">
                        <input type="text" name="laptop_make" class="form-control" id="make" placeholder="Make" value="{{ old('laptop_make', !empty($laptop) ? $laptop->laptop_make : '') }}" required data-bs-toggle="popover" data-bs-trigger="focus" data-bs-placement="top" data-bs-html="true" title="Laptop Manufacturer" data-bs-content="e.g. Lenovo, HP, Dell, Asus, etc.">
                     ...
                     <div class="col-lg-3 col-6 g-3 form-floating">
                        <input type="text" name="laptop_model" class="form-control" id="model" placeholder="Model" value="{{ old('laptop_model', !empty($laptop) ? $laptop->laptop_model : '') }}" required  data-bs-toggle="popover" data-bs-trigger="focus" data-bs-placement="top" data-bs-html="true" title="Laptop Model" data-bs-content="e.g. P52, Thinkpad L470, ROG GL503VD, etc.">
                ...
                <div class="row mb-2 ps-5 pe-3">
                    <div class="col-md-4 col-lg-2 g-3 form-floating">
                        <input type="text" name="laptop_cpu" class="form-control" id="cpu" placeholder="CPU" value="{{ old('laptop_cpu', !empty($laptop) ? $laptop->laptop_cpu : '') }}" required  data-bs-toggle="popover" data-bs-trigger="focus" data-bs-placement="bottom" data-bs-html="true" title="Laptop CPU" data-bs-content="e.g. Intel i7-8850H">
                     ...
                     <div class="col-md-4 col-lg-2 g-3 form-floating">
                        <input type="text" name="laptop_clock_speed" class="form-control" id="clock-speed" placeholder="Clock Speed (GHz)" value="{{ old('laptop_clock_speed', !empty($laptop) ? $laptop->laptop_clock_speed : '') }}" required  data-bs-toggle="popover" data-bs-trigger="focus" data-bs-placement="bottom" data-bs-html="true" title="CPU Clock Speed (in GHz)" data-bs-content="Usually beside CPU with unit GHz. <br> Accepted: <b>0.0 - 99.99</b>">
                     ...
                     <div class="col-md-4 col-lg-2 g-3 form-floating">
                        <input type="text" name="laptop_ram" class="form-control" id="ram" placeholder="RAM (GB)" value="{{ old('laptop_ram', !empty($laptop) ? $laptop->laptop_ram : '') }}" required data-bs-toggle="popover" data-bs-trigger="focus" data-bs-placement="bottom" data-bs-html="true" title="RAM (in GB)" data-bs-content="Input total memory of RAM (rounded-off) in Gigabytes. <br> Accepted: <b>0 - 255</b>">
