	    	...
	    	<table id="bug_list" class="table table-striped" >
		        ...
		        <tbody>
                    <tr data-bs-target="#bug_details" data-bs-toggle="modal">
                        ...
                        <td><a href="#">[B-1] The link does not redirect to details page</a></td>
                        <td>Laserna, Justine</td>
                        <td>2024-05-28 18:30</td>
                        <td><a href="#">DJP-5</a></td>
                        <td>Open</td>
                    </tr>
                    <tr>
                        <td>Syntax/Design Error</td>
                        <td><a href="#">[B-2] The spelling of the table header is incorrect</a></td>
                        <td>Laserna, Justine</td>
                    ...
                    <tr>
                        <td>Syntax/Design Error</td>
                        <td><a href="#">[B-3] The data displayed in the table is clipped</a></td>
                        <td>Laserna, Justine</td>
                    ...
                    <tr>
                        <td>Suggestion</td>
                        <td><a href="#">[B-4] The button color is inappropriate</a></td>
                        <td>Laserna, Justine</td>
