...
<div class="container ps-md-3 pe-md-3 pt-5">
    <h3 class="fw-bold">{{ $forUpdate ? 'Server Update' : 'Server Registration' }}</h3>
    <div class="pt-4">
            ...
            <div class="group-category p-3 mb-4 rounded-3">
                ...
                <div class="row mb-2 ps-5 pe-3">
                    <div class="col-lg-9 g-3">
                        <textarea class="form-control" name="function_role"  rows="3" id="function_role" required>{{ old('remarks', !empty($serverData) ? $serverData->function_role : '') }}</textarea>
                    </div>
                    @if ($errors->has('function_role'))
                    <p class="text-danger">{{ $errors->first('function_role') }}</p>
                    @endif
                </div>
                <div class="row pt-4 ps-3 pe-3">
                    <h5>Remarks</h5>
                                ...
                                <div class="row p-2">
                                    <div class="col-md-8 col-9">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                            <input name="hdd[1][partition_name]" type="text" class="form-control partition_name" id="partition_1">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="p-2">
                                    <div class="row g-0 pt-1">
                                        <div class="col-3 form-floating">
                                            <input name="hdd[1][total]" type="text" class="form-control hdd_total" id="hdd_total_1" placeholder="total">
                                            <label for="hdd_total_1">Total</label>
                                        </div>
                                        <div class="col-2 form-floating">
                                            <select name="hdd[1][total_unit]" id="hdd_total_unit_1" class="form-select form-control hdd_total_unit">
                                    ...
                                    <div class="row g-1 pt-2">
                                        <div class="col">
                                            <div class="form-check form-check-inline">
                                                <input type="radio" class="form-check-input hdd_select_radio hdd_size_radio" name="hdd[1][input_type]" id="hdd_size_radio_1" value="1" checked>
                                                <label class="form-check-label text-start" for="hdd_size_radio_1">Size</label>
                                            </div>
                                            <div class="row g-0 pt-2 text-center">
                                                <div class="col-6 form-floating">
                                                    <input name="hdd[1][used]" type="text" class="form-control hdd_used" id="hdd_used_1" placeholder="used">
                                                    <label for="hdd_used_1">Used</label>
                                                </div>
                                                <div class="col-4 form-floating">
                                                    <select name="hdd[1][used_unit]" id="hdd_used_unit_1" class="form-select form-control hdd_used_unit">
                                                        @foreach (config('constants.SIZE_UNITS') as $idx => $val)
                                                            <option value="{{ $idx }}">{{ $val }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="row g-0 pt-2 text-center">
                                                <div class="col-6 form-floating">
                                                    <input name="hdd[1][free]" type="text" class="form-control hdd_free" id="hdd_free_1" placeholder="Free">
                                                    <label for="hdd_free_1">Free</label>
                                                </div>
                                                <div class="col-4 form-floating">
                                                    <select name="hdd[1][free_unit]" id="hdd_free_unit_1" class="form-select form-control hdd_free_unit">
                                                        @foreach (config('constants.SIZE_UNITS') as $idx => $val)
                                                            <option value="{{ $idx }}">{{ $val }}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="col">
                                            <div class="form-check form-check-inline">
                                                <input type="radio" class="form-check-input hdd_select_radio hdd_percentage_radio" name="hdd[1][input_type]" id="hdd_percentage_radio_1" value="2">
                                                <label class="form-check-label text-start" for="hdd_percentage_radio_1">Percentage</label>
                                            </div>
                                            <div class="row g-0 pt-2 text-center">
                                                <div class="col-6 form-floating">
                                                    <input name="hdd[1][used_percentage]" type="text" class="form-control hdd_used_percentage" id="hdd_used_percentage_1" placeholder="used" disabled>
                                                    <label for="hdd_used_percentage_1">Used</label>
                                                </div>
                                            </div>
                                            <div class="row g-0 pt-2 text-center">
                                                <div class="col-6 form-floating">
                                                    <input name="hdd[1][free_percentage]" type="text" class="form-control hdd_free_percentage" id="hdd_free_percentage_1" placeholder="Free" disabled>
                                    ...
                                    <div class="hdd_partition p-1 pt-2">
                                        <div class="row p-2">
                                            <div class="col-md-8 col-9">
                                                <div class="row">
                                                    ...
                                                    <p class="text-danger">{{ $errors->first('hdd.' .$index .'.partition_name') }}</p>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-3 text-end">
                                        ...
                                        <div class="p-2">
                                            <div class="row g-0 pt-1">
                                                ...
                                                <p class="text-danger">{{ $errors->first('hdd.' .$index .'.total') }}</p>
                                                @endif
                                                @if ($errors->has('hdd.' .$index .'.total_unit'))
                                                <p class="text-danger">{{ $errors->first('hdd.' .$index .'.total_unit') }}</p>
                                                @endif
                                            </div>
                                            <div class="mt-2 pt-1 fw-semibold">
                                                Select mode of input:
                                            ...
                                            <div class="row g-1 pt-2">
                                                <div class="col">
                                                    ...
                                                    <div class="row g-0 pt-2 text-center">
                                                        ...
                                                        <p class="text-danger">{{ $errors->first('hdd.' .$index .'.used') }}</p>
                                                        @endif
                                                        @if ($errors->has('hdd.' .$index .'.used_unit'))
                                                        <p class="text-danger">{{ $errors->first('hdd.' .$index .'.used_unit') }}</p>
                                                        @endif
                                                    </div>
                                                    <div class="row g-0 pt-2 text-center">
                                                        <div class="col-6 form-floating">
                                                        ...
                                                        <p class="text-danger">{{ $errors->first('hdd.' .$index .'.free') }}</p>
                                                        @endif
                                                        @if ($errors->has('hdd.' .$index .'.free_unit'))
                                                        <p class="text-danger">{{ $errors->first('hdd.' .$index .'.free_unit') }}</p>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    ...
                                                    <div class="row g-0 pt-2 text-center">
                                                        ...
                                                        <p class="text-danger">{{ $errors->first('hdd.' .$index .'.used_percentage') }}</p>
                                                        @endif
                                                    </div>
                                                    <div class="row g-0 pt-2 text-center">
                                                        <div class="col-6 form-floating">
                                                        ...
                                                        <p class="text-danger">{{ $errors->first('hdd.' .$index .'.free_percentage') }}</p>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="col-md-6 ps-2">
                        <div class="group-category p-3 mb-4 pt-3 rounded-3">
                            ...
                            <div class="row g-0 pt-3">
                                ...
                                <p class="text-danger">{{ $errors->first('memory_total') }}</p>
                                @endif
                                @if ($errors->has('memory_total_unit'))
                                <p class="text-danger">{{ $errors->first('memory_total_unit') }}</p>
                                @endif
                            </div>
                            <div class="mt-2 pt-1 fw-semibold">
                                Select mode of input:
                            ...
                            <div class="row g-1 pt-2">
                                <div class="col"  id="memory_size_section">
                                    ...
                                    <div class="row g-0 pt-2 text-center">
                                        ...
                                        <p class="text-danger">{{ $errors->first('memory_used') }}</p>
                                        @endif
                                        @if ($errors->has('memory_used_unit'))
                                        <p class="text-danger">{{ $errors->first('memory_used_unit') }}</p>
                                        @endif
                                    </div>
                                    <div class="row g-0 pt-2 text-center">
                                        <div class="col-6 form-floating">
                                        ...
                                        <p class="text-danger">{{ $errors->first('memory_free') }}</p>
                                        @endif
                                        @if ($errors->has('memory_free_unit'))
                                        <p class="text-danger">{{ $errors->first('memory_free_unit') }}</p>
                                        @endif
                                    </div>
                                </div>
                                <div class="col" id="memory_percentage_section">
                                    ...
                                    <div class="row g-0 pt-2 text-center">
                                        ...
                                        <p class="text-danger">{{ $errors->first('memory_used_percentage') }}</p>
                                        @endif
                                    </div>
                                    <div class="row g-0 pt-2 text-center">
                                        <div class="col-6 form-floating">
                                        ...
                                        <p class="text-danger">{{ $errors->first('memory_free_percentage') }}</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 ps-2" id="cpu_usage_section">
                        <div class="group-category p-3 mb-4 pt-3 rounded-3">
                            ...
                            <div class="row g-1 pt-3">
                                ...
                                <p class="text-danger">{{ $errors->first('os_type') }}</p>
                                @endif
                                <div class="col-lg-4 col-md-6 col-4" id="linux_usage">
                                    ...
                                    <div class="row g-0 pt-2 text-center">
                                        ...
                                        @if ($errors->has('ni'))
                                        <p class="text-danger">{{ $errors->first('ni') }}</p>
                                        @endif
                                    </div>
                                    <div class="row g-0 pt-2 text-center">
                                        <div class="col-lg-8 col-md-6 col-8 form-floating">
                                        ...
                                        @if ($errors->has('sy'))
                                        <p class="text-danger">{{ $errors->first('sy') }}</p>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-4">
                                    ...
                                    <div class="row g-0 pt-2 text-center">
                                        ...
                                        <p class="text-danger">{{ $errors->first('other_os_percentage') }}</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
